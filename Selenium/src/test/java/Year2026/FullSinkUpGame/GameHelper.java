...
public class GameHelper {
    static final int HARIZONTAL_INCREAMENT = 1;
    private static final String ALPHABET = "abcdefg";
    private static final int GRID_LENGTH = 7;
    static final int VERTICAL_INCREAMENT = GRID_LENGTH;
    ...
    private boolean startupFits(int[] startupCoords, int increment) {
        ...
        if (increment == HARIZONTAL_INCREAMENT) {
//check end is same row on start
    ...
    private int getIncrement() {
        if (startupCount % 2 == 0) {
            return HARIZONTAL_INCREAMENT;
        } else {
            return VERTICAL_INCREAMENT;
        }
    }
